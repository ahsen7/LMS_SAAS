...
```bash
# .env.local
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_YnVzeS1tb2xsdXNrLTM0LmNsZXJrLmFjY291bnRzLmRldiQ
CLERK_SECRET_KEY=sk_test_oofdf24zO3rS59Rf6CguOIAB0e6Q6w4L0NFeObiaup
```
